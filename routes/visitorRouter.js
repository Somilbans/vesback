       ...
       then((visitor)=>{
            if(visitor!=null) {
               ...
               /*
                ...
                if(visitor.contactPersons[0].contacttype=='Admin')
                {
                    mailOptions.to= "qwertytech24@gmail.com"
                }
                else if(visitor.contactPersons[0].contacttype=='Marketing Manager'){
                    mailOptions.to= "somilbansal4u@yahoo.com"

                } 
                else{
                    mailOptions.to= "sbansal@techferry.com"

                }
                mailOptions.text="Hello " + visitor.contactPersons[0].contacttype +", \nNew visitor["+req.params.mobileno+"] has been arrived at ["+visitor.contactPersons[0].createdAt +"]. \nVisitor is waiting at reception. Please meet the person.\n\n\n\ Please Don't reply back.This message is automatically generated by system."    
